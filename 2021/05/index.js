...
function drawLine(point, lineType, grid) {
  ...
  if (lineType === 'horizontal') {
    start = point.y1 > point.y2 ? point.y2 : point.y1;
    end = point.y1 > point.y2 ? point.y1 : point.y2;
  } else {
    start = point.x1 > point.x2 ? point.x2 : point.x1;
    end = point.x1 > point.x2 ? point.x1 : point.x2;
  }
...
// function part2() {
//   const input = (await fs.promises.readFile('sample.txt', 'utf-8')).split('\n');
//   let answer = 0;
